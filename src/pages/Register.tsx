      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full gradient-primary text-primary-foreground py-4 rounded-xl font-bold text-lg hover:shadow-card-hover transition-all hover:scale-[1.01] flex items-center justify-center gap-2 disabled:opacity-50"
          >
            <CheckCircle size={20} />
